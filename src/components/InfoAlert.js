...
const InfoAlertFigureWrapper = styled.div``

const InfoAlertFigure = styled.figure`
  margin: 0;
  width: 25px;
  margin-right: 1rem;
  opacity: 0.7;
  margin-top: 0.0543rem;
`
...
const InfoAlertContent = styled.p`
  margin-bottom: 0;
`

const InfoAlert = props => {
  const { Warning, NoFigure, children } = props
  return (
    <>
      <InfoAlertWrapper Warning={Warning}>
        <InfoAlertContentWrapper>
          <InfoAlertFigureWrapper>
            {NoFigure ? (
              ``
            ) : (
              <InfoAlertFigure>
                {Warning ? (
                  <svg version="1.1" viewBox="0 0 455.881 455.881">
                    <g>
	...
	C156.146,65.765,156.146,74.362,150.862,79.646z"
          ...
          <InfoAlertContent>{children}</InfoAlertContent>
        </InfoAlertContentWrapper>
      </InfoAlertWrapper>
    </>
  )
